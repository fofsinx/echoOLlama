...
class WebSocketHandler:
    ...
    async def _check_rate_limits(self, client_id: str) -> None:
        ...
        """
        rate_limits = await self.db.get_rate_limits(client_id)
        ...
        for limit_type, limit in rate_limits.items():
            if current_time >= limit["reset_at"]:
                ...
                raise WebSocketError(
                    ...
                    code=4029,
                    data={"reset_in": limit["reset_at"] - current_time}
                )
    ...
    def handlers(self) -> Dict[str, callable]:
        ...
        return {
            ...
            MessageType.AUDIO_APPEND.value: self.handle_input_audio_buffer_append,
            MessageType.AUDIO_COMMIT.value: self.handle_input_audio_buffer_commit,
            MessageType.AUDIO_CLEAR.value: self.handle_input_audio_buffer_clear,
            MessageType.CONVERSATION_CREATE.value: self.handle_conversation_item_create,
            ...
            MessageType.RESPONSE_CREATE.value: self.handle_response_create,
